...
@WebServlet(name = "hospital" ,urlPatterns = "/patienturl", loadOnStartup = 1, initParams = {
		@WebInitParam(name = "val1", value = "first"), @WebInitParam(name = "val2", value = "second") })
public class PatientRegistrationServlet extends HttpServlet {
	...
	public void doGet(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
		...
		try {
			...
			pw.println("<h1 style='color:red;text-align:center' > ConfigObject init Params Values :: </h1>");
			pw.println("<h1 style='color:green;text-align:center' > val1 ::"+cg.getInitParameter("val1")+"</br>");
			pw.println(" val2 :: "+cg.getInitParameter("val2")+"</br>");
